  ...
  - group "iFrame Example" [ref=e174]:
    ...
    - iframe [ref=e176]:
      - generic [ref=f6e2]:
        - banner [ref=f6e3]:
              ...
              - list [ref=f6e12]:
                ...
                - listitem [ref=f6e16]:
                  - link "" [ref=f6e17] [cursor=pointer]:
                    ...
                    - generic [ref=f6e18]: 
              - link " Register" [ref=f6e20] [cursor=pointer]:
                - /url: https://courses.rahulshettyacademy.com/sign_up
                - generic [ref=f6e21]: 
                - text: Register
              - link " Login" [ref=f6e23] [cursor=pointer]:
          ...
          - generic [ref=f6e27]:
            - link [ref=f6e30] [cursor=pointer]:
              - /url: /
            - navigation [ref=f6e32]:
              - list [ref=f6e34]:
                - listitem [ref=f6e35]:
                  - link "Home" [ref=f6e36] [cursor=pointer]:
                    - /url: /
                - listitem [ref=f6e37]:
                  - link "Courses" [ref=f6e38] [cursor=pointer]:
                    - /url: https://courses.rahulshettyacademy.com/courses
                - listitem [ref=f6e39]:
                  - link "NEW All Access plan" [ref=f6e40] [cursor=pointer]:
                    - /url: lifetime-access
                - listitem [ref=f6e41]:
                  - link "NEW Learning paths" [ref=f6e42] [cursor=pointer]:
                    - /url: learning-path
                - listitem [ref=f6e43]:
                  - link "Mentorship" [ref=f6e44] [cursor=pointer]:
                    - /url: mentorship
                - listitem [ref=f6e45]:
                  - link "Job Support" [ref=f6e46] [cursor=pointer]:
                    - /url: consulting
                - listitem [ref=f6e47]:
                  - link "Practice" [ref=f6e48] [cursor=pointer]:
                    - /url: practice-project
                - listitem [ref=f6e49]:
                  - link "Blog" [ref=f6e50] [cursor=pointer]:
                    - /url: https://rahulshettyacademy.com/blog/
                - listitem [ref=f6e51]:
                  - link "More " [ref=f6e52] [cursor=pointer]:
                    - /url: "#"
                    - text: More
                    - generic [ref=f6e53]: 
                  - text: 
        - generic [ref=f6e54]:
          - generic [ref=f6e59]:
            - img "First slide" [ref=f6e60]
            - generic [ref=f6e62]:
              - heading "An Academy to Learn Earn & Shine in your QA Career" [level=2] [ref=f6e63]:
                - generic [ref=f6e64]:
                  - text: An Academy to
                  - strong [ref=f6e65]: Learn Earn & Shine
                  - text: in your QA Career
              - heading "World-class tutorials on Selenium, Rest Assured, Cypress, Appium, Postman, Cucumber, SoapUI, Playwright, Jmeter, Jira, and many more. Join our courses now to get the best job opportunity." [level=3] [ref=f6e66]
              - link "JOIN NOW" [ref=f6e68] [cursor=pointer]:
                - /url: https://courses.rahulshettyacademy.com/sign_up
          - generic [ref=f6e72]:
            - generic [ref=f6e74]:
              - generic [ref=f6e76]: 
              - generic [ref=f6e77]: 600,000 +
              - heading "Students" [level=4] [ref=f6e78]
            - generic [ref=f6e80]:
              - generic [ref=f6e82]: 
              - generic [ref=f6e83]: 30 +
              - heading "Courses" [level=4] [ref=f6e84]
            - generic [ref=f6e86]:
              - generic [ref=f6e88]: 
              - generic [ref=f6e89]: 257,000 +
              - heading "Ratings" [level=4] [ref=f6e90]
            - generic [ref=f6e92]:
              - generic [ref=f6e94]: 
              - generic [ref=f6e95]: 30 +
              - heading "Projects" [level=4] [ref=f6e96]
          - generic [ref=f6e99]:
            - heading "why we are Leaders in market?!" [level=2] [ref=f6e100]
            - generic [ref=f6e101]:
              - list [ref=f6e103]:
                - listitem [ref=f6e104]: The academy is led by Rahul Shetty, a Test evangelist and Test architect with over 10+ years in the IT industry.
                - listitem [ref=f6e105]: Rahul Shetty is a pioneer and authority in software testing space.
                - listitem [ref=f6e106]: He has taught over 300,000 students in 195 countries from across the world.
                - listitem [ref=f6e107]: All our courses are based on Real Time Project based where you learn real skill which are readily transferable to your work project.
                - listitem [ref=f6e108]: Our courses are guaranteed to help you reach your career goals and develop your automation skills
                - listitem [ref=f6e109]: Life time access, Learn at your own pace and updates are Free for Life.
              - list [ref=f6e111]:
                - listitem [ref=f6e112]: Wide coverage of topics like Selenium, Appium, Cucumber BDD, Cypress, Protractor, RestAPI, SoapUI and JMeter etc.
                - listitem [ref=f6e113]: His mentorship program is most after in the software testing community with long waiting period.
                - listitem [ref=f6e114]: Once under his mentorship, you are preparing yourself for long term success with his expert guidance and support.
                - listitem [ref=f6e115]: Lot of companies have already benefited from our consulting services.
                - listitem [ref=f6e116]: We are essentially a Full Stack QA consulting and Training company and we got you covered for your test implementation and training needs.
          - generic [ref=f6e118]:
            - generic [ref=f6e119]:
              - heading "Our Students" [level=2] [ref=f6e120]
              - generic [ref=f6e121]:
            ...
            - generic [ref=f6e122]:
              - generic [ref=f6e124]:
                ...
                - generic [ref=f6e154]:
                  - text: 
                  - heading "Gruffydd Dickerson" [level=4] [ref=f6e155]
                  - generic [ref=f6e156]: Student of software testing
                  - generic [ref=f6e157]: Guys,I was a Nervous newbie in this software testing few days ago, but by just completing my 50% course, I am now confident becoz of knowledge shared by Rahul shetty sir, that i will crack the job of Software Test Engineer. I was 0 in Technical field,but now i can say i have some rare knowledge which will help me to deal with my goals and challenges in testing. Trying my level best to explore more n more in testing due to CURIOSITY ABOUT SOFTWARE TESTING created in my mind by Rahul sir's Guidance.Thank You sir.
                  - generic [ref=f6e158]:
                    - generic [ref=f6e159]: 
                    - generic [ref=f6e160]: 
                    - generic [ref=f6e161]: 
                ...
                - generic [ref=f6e167]:
                  - text: 
                  - heading "Jesse Shepard" [level=4] [ref=f6e168]
                  - generic [ref=f6e169]: student of selenium
                  - generic [ref=f6e170]: I am so glad I found the right course and the right instructor. The instructor is too good..knowledgeable and supportive. I always get replies on my queries within hours and that helps me become productive.And this shows the dedication of the instructor as well. Very commendable and exceptional and elaborate teaching.Studying this course has increased my confidence.
                  - generic [ref=f6e171]:
                    - generic [ref=f6e172]: 
                    - generic [ref=f6e173]: 
                    - generic [ref=f6e174]: 
                ...
                - generic [ref=f6e180]:
                  - text: 
                  - heading "Zubair Rowley" [level=4] [ref=f6e181]
                  - generic [ref=f6e182]: Student of software testing
                  - generic [ref=f6e183]: Guys, I was a Nervous newbie in this software testing few days ago, but by just completing my 50% course, I am now confident becoz of knowledge shared by Rahul shetty sir, that i will crack the job of Software Test Engineer. I was 0 in Technical field, but now i can say i have some rare knowledge which will help me to deal with my goals and challenges in testing. Trying my level best to explore more n more in testing due to CURIOSITY ABOUT SOFTWARE TESTING created in my mind by Rahul sir's Guidance.Thank You sir.
                  - generic [ref=f6e184]:
                    - generic [ref=f6e185]: 
                    - generic [ref=f6e186]: 
                    - generic [ref=f6e187]: 
                ...
                - generic [ref=f6e193]:
                  - text: 
                  - heading "Sania Wynn" [level=4] [ref=f6e194]
                  - generic [ref=f6e195]: student of selenium
                  - generic [ref=f6e196]: I am so glad I found the right course and the right instructor. The instructor is too good..knowledgeable and supportive. I always get replies on my queries within hours and that helps me become productive. And this shows the dedication of the instructor as well. Very commendable and exceptional and elaborate teaching.Studying this course has increased my confidence.
                  - generic [ref=f6e197]:
                    - generic [ref=f6e198]: 
                    - generic [ref=f6e199]: 
                    - generic [ref=f6e200]: 
                ...
                - generic [ref=f6e206]:
                  - text: 
                  - heading "Gruffydd Dickerson" [level=4] [ref=f6e207]
                  - generic [ref=f6e208]: Student of software testing
                  - generic [ref=f6e209]: Guys,I was a Nervous newbie in this software testing few days ago, but by just completing my 50% course, I am now confident becoz of knowledge shared by Rahul shetty sir, that i will crack the job of Software Test Engineer. I was 0 in Technical field,but now i can say i have some rare knowledge which will help me to deal with my goals and challenges in testing. Trying my level best to explore more n more in testing due to CURIOSITY ABOUT SOFTWARE TESTING created in my mind by Rahul sir's Guidance.Thank You sir.
                  - generic [ref=f6e210]:
                    - generic [ref=f6e211]: 
                    - generic [ref=f6e212]: 
                    - generic [ref=f6e213]: 
                ...
                - generic [ref=f6e219]:
                  - text: 
                  - heading "Jesse Shepard" [level=4] [ref=f6e220]
                  - generic [ref=f6e221]: student of selenium
                  - generic [ref=f6e222]: I am so glad I found the right course and the right instructor. The instructor is too good..knowledgeable and supportive. I always get replies on my queries within hours and that helps me become productive.And this shows the dedication of the instructor as well. Very commendable and exceptional and elaborate teaching.Studying this course has increased my confidence.
                  - generic [ref=f6e223]:
                    - generic [ref=f6e224]: 
                    - generic [ref=f6e225]: 
                    - generic [ref=f6e226]: 
          ...
          - generic [ref=f6e229]:
            - generic [ref=f6e231]:
              - heading "Featured Courses" [level=2] [ref=f6e233]
              - generic [ref=f6e236] [cursor=pointer]:
                - generic: Dollar($) Rupee(₹)
            - link "VIEW ALL COURSES" [ref=f6e239] [cursor=pointer]:
              - /url: https://courses.rahulshettyacademy.com/courses
        - generic [ref=f6e242]:
          - generic [ref=f6e243]:
            - heading "JOIN OUR ACADEMY" [level=2] [ref=f6e244]
            - generic [ref=f6e245]: Sign up today and get access to "Core Java for Testers" & "QA Resume Preparation" Courses for FREE.
          - link "JOIN NOW" [ref=f6e248] [cursor=pointer]:
            - /url: https://courses.rahulshettyacademy.com/sign_up
        - contentinfo [ref=f6e249]:
          - generic [ref=f6e252]:
            - generic [ref=f6e254]:
              - text: All Right Reserved
              - link "RahulShettyAcademy" [ref=f6e255] [cursor=pointer]:
                - /url: "#"
              - text: © 2026
            - list [ref=f6e257]:
              - listitem [ref=f6e258]:
                - link "About Us" [ref=f6e259] [cursor=pointer]:
                  - /url: /about-my-mission
              - listitem [ref=f6e260]:
                - link "Contact Us" [ref=f6e261] [cursor=pointer]:
                  - /url: contact-us
              - listitem [ref=f6e262]:
                - link "Privacy Policy" [ref=f6e263] [cursor=pointer]:
                  - /url: /privacy
        - text: 
  - table [ref=e178]:
    - rowgroup [ref=e179]:
